...
const ProjectForm = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const project = { title, vak, academiejaar}
        console.log(project);
    ...
    return (
        <Form>
            ...
            <Form.Select className="mb-3" onChange= {(e)  => setAcademiejaar(e.target.value)} name="academiejaar" required> 
                ...
                <option value="2e Bachelor Ingenieurswetenschappen Architectuu">2e Bachelor Ingenieurswetenschappen Architectuur</option>
